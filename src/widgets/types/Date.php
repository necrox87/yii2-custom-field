<?php
namespace necrox87\field\widgets\types;

use yii\helpers\Html;
use yii\helpers\ArrayHelper;
use Yii;

class Date extends \yii\base\Widget
{
    public $model = NULL;
    public $field = null;
    public $options = [];
    ...
    public function run()
    {
        ...
        $input = Html::input('date', 'choice-field-value', $value, ['data-id' => $this->field->id, 'data-model-name' => $model::className(), 'data-item-id' => $this->model->id, 'class' => 'form-control', 'placeholder' => '']);
